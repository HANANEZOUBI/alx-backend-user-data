...
def _generate_uuid() -> str:
    """
    generate a uuid and return string representation of it
    """
...
class Auth:
    ...
    def get_user_from_session_id(self, session_id: str) -> Optional[User]:
        """
        find a user by the session_id and return the user
        """
    ...
    def destroy_session(self, user_id) -> None:
        """
        destroy a session and updates a use session_id to None
        """
        if user_id is None:
            return None
